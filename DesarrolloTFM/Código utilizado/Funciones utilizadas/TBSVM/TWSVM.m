function [Predict_Y,w1,w2,b1,b2,tf,W1_alp,W2_gam,alpha,gamma] = TWSVM(TestX,DataTrain,FunPara)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%DTWSVM1
    ...
    kerG1=(kerG1+kerG1')/2;
    t0=cputime;
    alpha=qpSOR(kerG1,0.5,cpos,0.0005); %SOR
    tf1=cputime-t0;
    vpos=-HHG*alpha;
%%%%DTWSVM2 equ(29)
    QQ=G'*G;
    ...
    kerH1=(kerH1+kerH1')/2;
    t0=cputime;
    gamma=qpSOR(kerH1,0.5,cneg,0.0005);
    tf=tf1+cputime-t0;
    vneg=QQP*gamma;
